...
using Task3_1.Shaders;
using Task3_1.Shapes;
...
public partial class Form1 : Form
{
    ...
    Vector3 _lightPos = new(3f, 1f, 0f);
    ...
    {
        IReadOnlyList<ParaboloidData> paraboloids = _shapeStore.Paraboloids;
        _shader.SetInt("paraboloidCount", paraboloids.Count);

        for (int i = 0; i < paraboloids.Count; i++)
        {
            _shader.SetVector3($"paraboloidPositions[{i}]", paraboloids[i].Position);
